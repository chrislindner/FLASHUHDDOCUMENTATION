	...
	\begin{description}
		...
		\begin{itemize}
			...
			\begin{enumerate}
				...
				\item \textbf{prim2flx} Converts from variables to fluxes.  {\color{red} $F = \rho v$, $F=\rho v v + P$, and $F= v(E + P)$} {\color{blue} We need to decide which fluxes to place here.  Most likely: replace total energy flux with radiation energy and gas energy fluxes.}
